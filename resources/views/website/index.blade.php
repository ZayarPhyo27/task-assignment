      ...
      <div class="modal-body">
        <div class="col-lg-12 col-md-12 me-3">
          <div class="image-holder">
            <img id="modalProductImage" src="" alt="Shoes">
          </div>
        </div>
          ...
          <div class="summary">
            <div class="summary-content fs-6">
              <div class="product-header d-flex justify-content-between mt-4">
                <h3 id="modalProductName" class="display-7"></h3>
                <div class="modal-close-btn">
                  <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
              </div>
              <span id="modalProductPrice" class="product-price fs-3"></span>
              <div class="product-details">
                <p id="modalProductDescription" class="fs-7"></p>
              </div>
              <ul class="select">
                <li><strong>Colour Shown:</strong> <span id="modalProductColor"></span></li>
                <li><strong>Size:</strong> <span id="modalProductSize"></span></li>
              </ul>
          ...
          <div class="shopping-cart">
            <div class="shopping-cart-content">
              ...
              <div class="modal-footer justify-content-center">
                ...
                <button type="button"
                  class="btn checkout btn-outline-gray hvr-sweep-to-right dark-sweep">Checkout</button>
              </div>
          </div>
        </div>
      </div>
      ...
      <div class="bg-gray coupon position-relative p-5">
        ...
        <div class="row justify-content-between align-items-center">
          ...
          <div class="col-lg-3 col-md-12">
            <div class="btn-wrap">
              <a href="#" class="btn btn-black btn-medium text-uppercase hvr-sweep-to-right">Shop Now</a>
            </div>
          </div>
        </div>
      </div>
               ...
               <div class="col mb-4">
                    <div class="product-card position-relative">
                        <div class="card-img">
                            ...
                            <img src="{{ $product->image ? asset('storage/'.$product->image) : asset('assets/images/card-item1.jpg') }}"
                                alt="{{ $product->name }}"
                            ...
                            <div class="cart-concern position-absolute d-flex justify-content-center">
                                <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
                                    ...
                                    <button type="button"
                                        class="btn btn-light add-to-cart-btn"
                                        ...
                                        data-image="{{ $product->image ? asset('storage/'.$product->image) : asset('assets/images/card-item1.jpg') }}">
      ...
      <div class="row">
        <div class="col-lg-6 col-md-6 mb-4">
          <div class="collection-card card border-0 d-flex flex-row align-items-end jarallax-keep-img">
            <img src={{ asset('assets/images/collection-item1.jpg') }} alt="product-item" class="border-rounded-10 img-fluid jarallax-img">
        ...
        <div class="col-lg-6 col-md-6">
          <div class="collection-card card border-0 d-flex flex-row jarallax-keep-img">
            <img src={{ asset('assets/images/collection-item2.jpg') }} alt="product-item" class="border-rounded-10 img-fluid jarallax-img">
            <div class="card-detail p-3 m-3 p-lg-5 m-lg-5">
              <h3 class="card-title display-3">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
        document.querySelectorAll('.quick-view-btn').forEach(button => {
         ...
         const cartContainer = document.querySelector('#modallong .shopping-cart-content');
    const subtotalElement = document.querySelector('#modallong .price-amount bdi');
    let subtotal = 0;
        ...
        document.querySelectorAll('.add-to-cart-btn').forEach(button => {
            button.addEventListener('click', function () {
                ...
                // Append product to cart dynamically
                ...
                cartItem.innerHTML = `
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8">
                        ...
                        <div class="quantity-price d-flex justify-content-between align-items-center">
                            <div class="product-title fs-6 me-5">${color} - Quantity : 1</div>
        ...
        function updateSubtotal() {
            let total = 0;
            document.querySelectorAll('#modallong .product-price').forEach(priceEl => {

                total += parseFloat(priceEl.textContent.replace('$', ''));

            });
            subtotalElement.innerHTML = `<span class="price-currency-symbol">$</span>${total.toFixed(2)}`;
        }

        cartContainer.addEventListener('click', function (e) {
        const removeBtn = e.target.closest('.remove'); // catch clicks on a/remove/svg/use

        if (removeBtn) {
            const item = removeBtn.closest('.mini-cart-item');
            if (item) {
                item.remove();
                updateSubtotal();
            }
    ...
    if (checkoutBtn) {
        checkoutBtn.addEventListener('click', function () {
            ...
            document.querySelectorAll('#modallong .mini-cart-item').forEach(item => {
                ...
                const product_id = item.querySelector('.product_id')?.value || null;;
                const quantity = quantityElement ? parseInt(quantityElement.value) : 1;
                const image = item.querySelector('img').getAttribute('src');

                cartData.push({ name, price, quantity,image ,product_id});
            });

            localStorage.setItem('cartItems', JSON.stringify(cartData));

            window.location.href = 'website/checkout'; // change route to your Laravel checkout
        });
    }
